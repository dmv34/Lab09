...
//            hardCodedPlayers.add(new Player(2, "jdoe2", "Jane Doe"));
    ...
    private static final String DB_URI = "jdbc:postgresql://localhost:5526/monopoly";
    private static final String DB_LOGIN_ID = "postgres";
    private static final String DB_PASSWORD = "postgres";

    /* GET method retrieves the players from DB by created a connection with the DB
